 ...
 * edit: feb-05, 11:24, mon-2024; copy dari item_look.js
 * edit: aug-23, 11:16, fri-2024; r13;
 * edit: oct-07, 21:08, mon-2024; #20;
 */ 
 
'use strict';

class ActivityItemLook{
  
  constructor(mother){
    this.mother=mother;
    this.url='activity_items';
    this.title='Activity Items';
    this.hideNew=true;
  ...
  addSelectFn(indek){
    ...
    for(var i=0;i<n.length;i++){
      ...
      n[i].onclick=function(){
        m.setActivityItem(p,d[this.dataset.i]);
        ui.CLOSE_POP(indek);
      }
    }
  }
