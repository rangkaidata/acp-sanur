 ...
 * -----------------------------; happy new year 2024;
 * edit: jan-05, 14:53, fri-2024; new concepts;
 * edit: jan-09, 18:10, tue-2024; re-write with class;
 * edit: may-17, 21:30, fri-2024; basic sql;
 * edit: jun-27, 13:01, wed-2024; r3;
 * edit: sep-10, 21:28, tue-2024; r18;
 */ 
  ...
  readShow(indek) {
    ...
    if (p.err.id===0){
      for (var x in d) {
        ...
        +'<td align="left">'+d[x].calculate+'</td>'
        +'<td align="center">'
          +'<button type="button" '
          +' name="select_'+indek+'" '
          +' class="icon_select" >'
  ...
  addSelectFn(indek){
    ...
    for(var i=0;i<n.length;i++){
      ...
      n[i].onclick=function(){
        bigBos.setItemTaxes(indek_parent,data[this.dataset.i]);// here ...
        ui.CLOSE_POP(indek);
      }
    }
  }
